...
import { ExternalLink, FileText, PlayCircle, Trash, Zap } from "lucide-react";
...
interface ActionBlockProps extends NodeProps {
  data: {
    id: string;
    name: string;
    description?: string;
...
export const ActionBlock = memo(({ data, isConnectable }: ActionBlockProps) => {
