...
import { generateFunction } from "~/lib/ai/generate-function";
...
export const FunctionNodeV2 = memo(
  ({
    data: _data,
    selected,
    positionAbsoluteX,
            ...
            >
              ...
              >
                <div className="border-b">
                  <div className="p-4">
                    <ExpandableCardHeader className="flex flex-col items-start justify-start p-0">
                      <div className="flex w-full items-center justify-between">
                        <div className="flex items-center gap-2 text-xs">
                          <LambdaIcon className="size-4 text-primary" />
                ...
                <div className="flex flex-col h-[calc(100dvh-508px)] pt-0 p-4">
                  ...
                  <div className="mt-auto">
                    <form
                      ...
                      onSubmit={async (e) => {
                        ...
                        const result = await generateFunction(newMessages);
